...
//Translator translator("path_to_model");
//auto results = translator.translate_batch({{"Hello", "world"}});
//std::cout << results[0].output[0] << std::endl;
...
int main (void)
{
/*int main(int argc, char **argv)Buddy: Jeju National Museum, also known as the Jeju Museum of Art, is locat
{
    if (argc < 4) {
